...
export const bodyResults: Record<string, DiagnosisResult> = {
  straight: {
    ...
    fashion: [
      { item: "ジャストサイズのテーラードジャケット", reason: "上半身の厚みがそのまま活き、体の立体感がシルエットに映える" },
      { item: "シンプルなVネックニット", reason: "首が短めでもV字の開きで顔周りがすっきりし、小顔効果が出る" },
      { item: "ストレートパンツ・センタープレスパンツ", reason: "縦のラインが強調され、上半身のボリュームとバランスが取れる" },
      { item: "ハリのある素材のシャツ", reason: "筋肉質な肌のハリ感と素材のハリが調和し、清潔感が増す" },
      { item: "レザーシューズ", reason: "重厚な体格に負けない存在感が足元に出て、全体が引き締まる" },
    ],
    ngItems: [
      { item: "オーバーサイズすぎる服", reason: "厚みのある体がさらに膨張して見え、太った印象になる" },
      { item: "丈の長すぎるカーディガン", reason: "上半身の重心がぼやけて、だらしなく見える" },
      { item: "ローライズのパンツ", reason: "せっかくの腰位置の高さが活かせず、脚が短く見える" },
      { item: "長い着丈のトップス", reason: "上半身の立体感が隠れ、全体がもっさりした印象になる" },
    ],
  ...
  wave: {
    ...
    fashion: [
      { item: "タイトめのニットやカットソー", reason: "華奢な上半身に沿うことで、スタイリッシュに見える" },
      { item: "スキニーパンツ・テーパードパンツ", reason: "細い脚のラインがきれいに出てスタイルアップする" },
      { item: "ショート丈のジャケット", reason: "重心が上がり、腰位置の低さをカバーできる" },
      { item: "ソフトな素材のシャツ", reason: "柔らかい肌質と素材の質感が調和し、上品な印象になる" },
      { item: "クロスボディバッグ", reason: "上半身にアクセントが加わり、華奢さが「こなれ感」に変わる" },
    ],
    ngItems: [
      { item: "ざっくりしたローゲージニット", reason: "華奢な体が泳いでしまい、服に着られている感じになる" },
      { item: "オーバーサイズのダウンジャケット", reason: "上半身の薄さが強調され、全体のバランスが崩れる" },
      { item: "ワイドパンツ", reason: "下半身のボリュームが増し、重心の低さがさらに際立つ" },
      { item: "硬い素材のアウター", reason: "柔らかい体のラインと素材感がミスマッチし、ゴワつく" },
    ],
  ...
  natural: {
    ...
    fashion: [
      { item: "オーバーサイズのシャツ・ジャケット", reason: "肩幅の広さをラフに活かし、こなれた雰囲気になる" },
      { item: "ワイドパンツ・カーゴパンツ", reason: "骨格のフレーム感にゆとりのあるシルエットが自然にハマる" },
      { item: "ざっくりニット・パーカー", reason: "骨や関節の凹凸をカバーしつつ、ラフさが似合う体型と好相性" },
      { item: "デニム・リネン等の天然素材", reason: "硬めの肌質と天然素材のザラッとした風合いが調和する" },
      { item: "スニーカー・ブーツ", reason: "カジュアルな足元がフレーム感のある体型と自然にマッチする" },
    ],
    ngItems: [
      { item: "タイトすぎるスーツ", reason: "骨格のゴツさが強調され、窮屈で不自然に見える" },
      { item: "ジャストサイズのVネック", reason: "鎖骨や骨の凹凸が目立ちすぎて貧相な印象になる" },
      { item: "光沢のある素材", reason: "骨や関節のゴツゴツ感が光で強調されてしまう" },
      { item: "きっちりしすぎたコーデ", reason: "骨格のラフさとテイストが合わず、違和感が出る" },
    ],
