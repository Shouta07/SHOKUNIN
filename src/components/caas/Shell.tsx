  ...
  return (
    <div className="caas-shell">
      ...
      <aside className="caas-sidebar">
        <div>
          <Link href="/caas" className="caas-logo">
            <span className="caas-logo-mark">C</span>
            <div>
              <div className="caas-logo-name">CaaS</div>
              <div className="caas-logo-sub">Construction as a Service</div>
            </div>
          </Link>
      ...
      <header className="caas-topbar">
        <Link href="/caas" className="caas-topbar-brand">
          <span className="caas-logo-mark sm">C</span>
          <span>CaaS</span>
        </Link>
        <span className="caas-topbar-sub">Construction as a Service</span>
      </header>
      ...
      <style>{`
        .caas-shell { min-height: 100dvh; background: ${C.bg}; }
        .caas-sidebar, .caas-topbar, .caas-tabbar { font-family: ${SANS_CSS}; }

        /* app-wide tactile feedback */
        ...
        /* nav (sidebar) */
        .caas-nav { display: flex; flex-direction: column; gap: 4px; margin-top: 28px; }
        ...
        .caas-topbar-sub { font-size: 10px; color: ${C.faint}; }
        ...
        @media (max-width: 899px) {
          ...
          .caas-topbar { display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 40; padding: 13px 18px; background: rgba(245,247,250,0.85); backdrop-filter: blur(12px); border-bottom: 1px solid ${C.line}; }
